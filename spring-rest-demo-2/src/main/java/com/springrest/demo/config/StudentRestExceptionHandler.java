...
@ControllerAdvice // allow for global exception handling
public class StudentRestExceptionHandler {

	// add an exception handler

	// @ExceptionHandler(StudentNotFoundException.class) you can also write like
	// that.
	@ExceptionHandler
	...
	public ResponseEntity<StudentErrorResponse> handleException(Exception exe) {
		...
		error.setMessage(exe.getMessage());
		// error.setMessage("fsdk"); you can set any message
		error.setTimeStamp(System.currentTimeMillis());
